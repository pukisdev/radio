                            ...
                            <div class="row">
                                <div>
                                    <div class="col-md-12">
                                        <div class="xpanel">
                                            <div class="x_title">
                                                <h2>Form Report Nota Penerimaan</h2>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group col-sm-6">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-default" type="button" ng-click="lovPenerimaan(0)">...</button>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>        
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group col-sm-6">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-default" type="button" ng-click="lovPenerimaan(1)">...</button>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
...
{!! Html::script('assets/ng/controllers/keu/rptPenerimaan.min.js') !!}
{!! Html::script('assets/ng/controllers/keu/lovPenerimaan.min.js') !!}
