...
@section('content')
<div class="container" ng-controller="costCenterController">
    <div class="row">
        <div class="col-md-12">
                            ...
                            <table class="table table-bordered pagin-table">
                                ...
                                <tbody>
                                    ...
                                    <tr  dir-paginate="values in _data | itemsPerPage:5" total-items="totalItems">
                                        <td>[[ values.cost_id ]]</td>
                                        <td>[[ values.cost_keterangan ]]</td>
                                        <td>
                                            <button class="btn btn-default btn-xs btn-detail" ng-click="toggle('edit', values.cost_id)">Edit</button>
                                            <!--
...
<script src="<?= asset('assets/ng/controllers/keu/costCenter.min.js') ?>"></script>
<script src="<?= asset('assets/ng/controllers/pms/lovCustomer.min.js') ?>"></script>
@endsection