                            ...
                            <table class="table table-bordered pagin-table">
                                ...
                                <tbody>
                                    ...
                                    <tr  dir-paginate="values in _data | itemsPerPage:5" total-items="totalItems">
                                        ...
                                        <td>[[ values.nama_trans ]]</td>
                                        <td>
                                            <button class="btn btn-default btn-xs btn-detail" ng-click="formData(values.kode_trans)">Edit</button>
                                            <!--
...
{!! Html::script('assets/ng/controllers/acc/transArMst.min.js') !!}
{!! Html::script('assets/ng/controllers/acc/modalTransArMst.min.js') !!}
@endsection
