...
class fa_penerimaan_ar_det extends Model
{
    //
    // protected $alias		= "bi_keu.";		
	protected $table		= 'bi_keu.fa_penerimaan_ar_det';	
	// protected $primaryKey 	= 'no_bukti';
	public $incrementing	= false;
	public $timestamps 		= false;
	protected $fillable 	= array('no_bukti', 'coa_id', 'no_faktur', 'currency_id','keterangan', 'nilai_potong', 'nilai_bayar', 
								'coa_id_cust','nama_customer');
