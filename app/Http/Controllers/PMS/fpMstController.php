...
use App\Http\Models\pms\pms_fp_det as modelDet;
...
class fpMstController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        modelMst::create([
                    ...
                    'tgl_fp'            => \DateTime::createFromFormat('D M d Y H:i:s e+', $request->tgl_fp),
                    'deskripsi_fp'      => $request->deskripsi_fp,
                    //'tgl_jatuh_tempo'   => Carbon::parse($request->tgl_jatuh_tempo),
                    'tgl_jatuh_tempo'   => \DateTime::createFromFormat('D M d Y H:i:s e+', $request->tgl_jatuh_tempo),
