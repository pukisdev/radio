...
app.controller('dataFormController', function($scope, $http, $sce, $uibModal, $log) {
  ...
  $scope._pageNumber = 1;
    ...
    $scope.toggle = function(modalstate, id){
      ...
      $http.get(_url+'Jenis').success(function(response){
        $scope.dataTipe = response;
      });

      $http.get(_url+'Tipe').success(function(response){
        $scope.dataJenis = response;
      });
