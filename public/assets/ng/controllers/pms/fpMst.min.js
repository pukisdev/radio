...
app.controller('dataFormController', function($scope, $http, $sce, $uibModal, $log){//, API_URL) {
  ...
  $scope._pageNumber=1;
    ...
    $scope.save = function(modalstate, id){
      ...
      $http({
        'method'  : _method,
        'url'     : _url+ (angular.isUndefined($scope.dataFormParam['id_fp']) ? '' : '/'+id),
  ...
  $scope.lovPnwr = function (_index, _add) {
    ...
    var modalInstance = $uibModal.open({
      animation: true,
      templateUrl: '/assets/ng/views/pms/lov/lovPnwr.html',
...
app.directive('formFpMst', function (){
    return{
        restirct    : 'A',
        templateUrl : '/assets/ng/views/pms/forms/formFPMst.html',
    };
});
