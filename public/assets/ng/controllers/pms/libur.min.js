app.controller('liburController', function($scope, $http){//, API_URL) {
  ...
  // $idScope = 'id_tanggal';
    ...
    $scope.rekap = function(_param){
      var _url = $scope._token['url']+'/rpt'+'/'+_param+$scope.subUrl;
      if($.isEmptyObject($scope._token)) return false;
...
app.directive('modalLibur', function (){
    return{
        restirct    : 'A',
        templateUrl : '/assets/ng/views/pms/forms/modalLibur.html',
    };
});
