...
app.controller('costCenterController', function($scope, $http, $sce, Upload) {
  $scope.parseInt = parseInt;
  $scope.libraryTemp = {};
  $scope.dataForm = {};
  $scope.totalItemsTemp = {};
  $scope.totalItems = 0;
  $scope.subUrl = '/keu/cost_center';
  ...
  $scope.save = function(modalstate, id){
      ...
      $http({
        ...
        //alert(response);
        if(modalstate === 'edit') {
          $scope._data  = apiModifyTable($scope._data, response.id, response);
...
app.directive('modalCostCenter', function (){
    return{
        restirct    : 'A',
        templateUrl : '/assets/ng/views/keu/lov/modalCostCenter.html',
    };
});
