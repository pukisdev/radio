...
app.controller('dataFormController', function($scope, $http, $uibModal, $log) {
  ...
  $scope.checked = false;
    ...
    $scope.lovPembayaran = function (val){
      ...
      var modalInstance = $uibModal.open({
        animation: true,
        templateUrl:  '/assets/ng/views/keu/lov/lovPembayaran.html', 
        controller:   'lovPembayaranController',
        size: 'lg',
        resolve: {
          parameter : function(){
            return $scope.params;
    ...
    $scope.cetak = function () {
      ...
      //$('#frmMst').attr('action', '/rpt/pdf/keu/notaPembayaran/'+jenis+'/'+awal+'/'+akhir);
      //$('#frmMst').attr('method', 'GET');
      //$('#frmMst').submit();
      
      //window.open('/rpt/pdf/keu/notaPembayaran/'+jenis+'/'+awal+'/'+akhir);
      ...
      $('#frmMst').attr('action', '/rpt/pdf/keu/notaPembayaran');
