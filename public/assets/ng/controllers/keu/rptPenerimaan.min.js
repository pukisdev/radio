...
app.controller('dataFormController', function($scope, $http, $uibModal, $log) {
  ...
  $scope.checked = false;
    ...
    $scope.lovPenerimaan = function (val){
      ...
      var modalInstance = $uibModal.open({
        animation: true,
        templateUrl:  '/assets/ng/views/keu/lov/lovPenerimaan.html', 
        controller:   'lovPenerimaanController',
        size: 'lg',
        resolve: {
          parameter : function(){
            return $scope.params;
    ...
    $scope.cetak = function () {
      ...
      $('#frmMst').attr('action', '/rpt/pdf/keu/notaPenerimaan');
