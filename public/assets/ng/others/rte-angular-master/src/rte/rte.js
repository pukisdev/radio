...
directive('rte', function ($sce) {
  ...
  return {
    restrict: 'E',
    require: 'ngModel',
    templateUrl: '/assets/ng/others/rte-angular-master/src/rte/rte.html',
    // templateUrl: '/ext/rte-angular-master/src/rte/rte.html',
...
directive('rteDialog', function () {
  return {
    ...
    templateUrl: '/assets/ng/others/rte-angular-master/src/rte/rte-dialog.html'
    // templateUrl: '/ext/rte-angular-master/src/rte/rte-dialog.html'
