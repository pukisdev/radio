...
class PmsPnwrMst extends Migration
{
    ...
    public function up()
    {
        Schema::create('pms_pnwr_mst', function (Blueprint $table) {
            ...
            $table->mediumInteger('tarif', false, true);
            ...
            $table->mediumInteger('tarif_normal',false,true);
            $table->mediumInteger('tarif_diskon',false,true);
            $table->mediumInteger('tarif_potongan',false,true);
            $table->mediumInteger('tarif_hpp',false,true);
            $table->mediumInteger('tarif_ppn',false,true);
            $table->mediumInteger('tarif_total',false,true);
            $table->mediumInteger('pnwr_hpp',false,true);
